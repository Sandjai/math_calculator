...
import {
  ...
  entities,
  generalPadding,
} from "../components/constants/elementsSettings";
...
export const clearRect = (context: CanvasRenderingContext2D | null) => {
  if (context !== null) {
...
let drawButton: Ibutton = function (
  context,
  i,
  element,
  currentHeight,
  ...
  context.fillText(
    element.data[i],
    txtShift + shift * (i % element.columns),
    currentHeight + 27
  );
};

export const drawElements: IdrawElements = (
  context,
  inCanvas,
  activeEl,
  clickedOn,
